namespace NewDemoProject
{
    //class CheckboxDemo
    //{
    //Perrašom savo "Checkbox" testą arba mano iš 
    //https://github.com/dreadonmyhead/vcsdemotests/blob/main/CheckboxDemo.cs į Page Object šabloną.
    ...
    //    {
    //        IWebElement oneCheckBox = chromeDriver.FindElement(By.Id("isAgeSelected")); /*IWebElement inputField = chromeDriver.FindElement(By.Id("sum1"));*/
